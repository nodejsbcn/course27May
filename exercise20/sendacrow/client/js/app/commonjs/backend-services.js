  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Message.responses.destroyById() instead.
        ...
        // INTERNAL. Use Message.responses.updateById() instead.
        ...
        // INTERNAL. Use Message.responses.create() instead.
        "prototype$__create__responses": {
          url: urlBase + "/Messages/:id/responses",
          method: "POST"
        },

        // INTERNAL. Use Message.responses.destroyAll() instead.
        ...
        // INTERNAL. Use Message.responses.createMany() instead.
        "::createMany::Message::responses": {
          isArray: true,
          url: urlBase + "/Messages/:id/responses",
          method: "POST"
        },
    ...
    */
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Message.responses#create
         * @methodOf lbServices.Message.responses
         *
         * @description
         *
        ...
        R.responses.create = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::create::Message::responses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Message.responses#createMany
         * @methodOf lbServices.Message.responses
         *
         * @description
         *
        ...
        R.responses.createMany = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::createMany::Message::responses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Message.responses#destroyAll
         * @methodOf lbServices.Message.responses
         *
         * @description
         *
        ...
        R.responses.destroyAll = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::delete::Message::responses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Message.responses#destroyById
         * @methodOf lbServices.Message.responses
         *
         * @description
         *
        ...
        R.responses.destroyById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::destroyById::Message::responses"];
          return action.apply(R, arguments);
        };
        ...
        /**
         * @ngdoc method
         * @name lbServices.Message.responses#updateById
         * @methodOf lbServices.Message.responses
         *
         * @description
         *
        ...
        R.responses.updateById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::updateById::Message::responses"];
          return action.apply(R, arguments);
        };
